...
### 1. Variante mit eigenständigem Einrichten:
...
Um unseren Chatbot auf diese Weise zum Laufen zu kriegen, muss man nur die 'Chatbot-mit-Neural-Network.exe'-Datei ausführen und schon startet unser Chatbot, sowie bei der anderen Methode auch. Der Ordner mit dieser .exe-Datei liegt in unserem Ordner in dem Informatikgruppenordner auf iServ. Diese Variante haben wir für das Testen für Herrn Buhl vorgesehen.
